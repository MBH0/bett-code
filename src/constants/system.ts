...
const DEFAULT_PREFIX = `You are bett-code, an AI coding assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are bett-code, an AI coding assistant, running within the Claude Agent SDK.`
