...
export const MACOS_BUNDLE_ID = 'com.bett-code.bett-code-url-handler'
const APP_NAME = 'bett-code URL Handler'
const DESKTOP_FILE_NAME = 'bett-code-url-handler.desktop'
const MACOS_APP_NAME = 'bett-code URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>bett-code Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for bett-code
