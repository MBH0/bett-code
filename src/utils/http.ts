...
import { getBettCodeUserAgent } from './userAgent.js'
...
export function getUserAgent(): string {
  ...
  return `bett-code/${MACRO.VERSION} (${process.env.USER_TYPE}, ${process.env.CLAUDE_CODE_ENTRYPOINT ?? 'cli'}${agentSdkVersion}${clientApp}${workloadSuffix})`
}
...
export function getMCPUserAgent(): string {
  ...
  return `bett-code/${MACRO.VERSION}${suffix}`
}
