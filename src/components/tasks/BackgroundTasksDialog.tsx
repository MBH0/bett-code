...
const workflowTaskModule = feature('WORKFLOW_SCRIPTS') ? require('../../tasks/LocalWorkflowTask/LocalWorkflowTask.js') as typeof import('src/tasks/LocalWorkflowTask/LocalWorkflowTask.js') : null;
