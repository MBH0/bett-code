...
var PR_TITLE = "Add bett-code GitHub Workflow", GITHUB_ACTION_SETUP_DOCS_URL = "https://github.com/anthropics/claude-code-action/blob/main/docs/setup.md", WORKFLOW_CONTENT = `name: bett-code
...
`, PR_BODY = `## \uD83E\uDD16 Installing bett-code GitHub App

This PR adds a GitHub Actions workflow that enables bett-code integration in our repository.

### What is bett-code?

[bett-code](https://claude.com/claude-code) is an AI coding agent that can help with:
...
After merging this PR, let's try mentioning @claude in a comment on any PR to get started!`, CODE_REVIEW_PLUGIN_WORKFLOW_CONTENT = `name: bett-code Review
