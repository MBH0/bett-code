...
async function createBridgeSession({
  ...
  const { getClaudeAIOAuthTokens } = await import("./chunk-a2k5tfh5.js");
  const { getOrganizationUUID } = await import("./chunk-7hh05qkh.js");
  const { getOauthConfig } = await import("./chunk-d0dxv80p.js");
  const { getOAuthHeaders } = await import("./chunk-h8zk09hh.js");
  const { parseGitHubRepository } = await import("./chunk-45gbqe9w.js");
  const { getDefaultBranch } = await import("./chunk-m0vaysac.js");
  const { getMainLoopModel } = await import("./chunk-g21r719k.js");
  const { default: axios } = await import("./chunk-yqdjpw0q.js");
  ...
  let gitOutcome = null;
  if (gitRepoUrl) {
    const { parseGitRemote } = await import("./chunk-45gbqe9w.js");
