...
function LogoV2() {
  ...
  const borderTitle = ` ${color("claude", userTheme)("bett-code")} ${color("inactive", userTheme)(`v${version}`)} `;
  const compactBorderTitle = color("claude", userTheme)(" bett-code ");
