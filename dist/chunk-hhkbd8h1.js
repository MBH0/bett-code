...
var logError2 = (result, verboseInfo) => {
  if (result.failed) {
    verboseLog({
      type: "error",
...
export { figures_default, init_figures, require_cross_spawn, onExit, init_mjs, execa, execaSync, init_execa, execSyncWithDefaults_DEPRECATED, init_execFileNoThrowPortable, execFileNoThrow, execFileNoThrowWithCwd, init_execFileNoThrow };
